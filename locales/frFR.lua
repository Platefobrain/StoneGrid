...
StoneGrid_Locales["frFR"] = {
    ...
    ShowPvpIcons   = "Afficher icones PVP",
    ShowPveIcons   = "Afficher icones PVE",
    ...
    BuffHideLabel = "Masquer (noms séparés par virgule):",
    DebuffHideLabel = "Masquer (noms séparés par virgule):",
    Debuffs      = "[ Debuffs ]",
